...
const checklistData: ChecklistItem[] = [
  ...
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Система кастомных полей с различными типами данных',
    priority: 'medium',
    estimatedHours: 16
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Полная система тегов с категориями и поиском',
    priority: 'medium',
    estimatedHours: 8
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Настраиваемый экспорт в различных форматах',
    priority: 'low',
    estimatedHours: 12
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Возможность начать диалог через разные каналы',
    priority: 'medium',
    estimatedHours: 6
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Система упоминаний с уведомлениями',
    priority: 'low',
    estimatedHours: 8
  },
  ...
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Личный кабинет для клиентов с управлением тикетами',
    priority: 'medium',
    estimatedHours: 24
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Расширенные профили и статусы с настройкой',
    priority: 'low',
    estimatedHours: 12
  },
  ...
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Полная система управления сохраненными фильтрами',
    priority: 'medium',
    estimatedHours: 8
  },
  ...
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Настройка визуального оформления с предпросмотром',
    priority: 'low',
    estimatedHours: 8
  },
  {
    ...
    status: 'completed-demo',
    comment: 'Портал помощи для клиентов с полным функционалом',
    priority: 'medium',
    estimatedHours: 20
  },
