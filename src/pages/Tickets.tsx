...
const Tickets = () => {
  ...
  // Контейнер горизонтальной прокрутки таблицы (горизонтальная полоса всегда видна)
      ...
      <Card className="flex-1 bg-gradient-to-br from-card to-card/50">
        ...
        <CardContent className="p-0 relative">
          <div className="relative h-[calc(100vh-400px)]">
            <div ref={tableScrollRef} className="absolute inset-0 overflow-x-auto overflow-y-hidden">
